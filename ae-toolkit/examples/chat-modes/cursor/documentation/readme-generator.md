...
This mode creates comprehensive README files that help developers get started quickly, clearly explain what the project does and why, and guide contributors. Use it when starting new projects or improving outdated documentation.

## Configuration

### Tools
- Codebase Search - Understand project structure
- File Reading - Read package.json, dependencies, configs
- Edit & Reapply - Create README file
- Terminal - Test setup instructions
- Documentation Access - Read existing docs

### Model
Recommended: Claude 3.5 Sonnet or GPT-4 (for comprehensive README)
...
**Prompt**: "Create a README for my Express API project. It uses PostgreSQL, requires Node 18+, and has JWT authentication."

**Expected Behavior**: Mode generates clear project description, prerequisites (Node 18+, PostgreSQL), quick start with working commands, database setup, environment variables, API endpoint examples, development workflow.

### Example 2: Python Project
**Prompt**: "Generate README for my data analysis project. Uses Python 3.11, Jupyter notebooks, and processes CSV files."

**Expected Behavior**: Mode generates description of analysis purpose, prerequisites, virtual environment setup, installation with requirements.txt, how to run notebooks, data file format requirements.

### Example 3: Library
**Prompt**: "Create README for my TypeScript utility library. It's published on npm and needs good examples."

**Expected Behavior**: Mode generates clear value proposition, NPM installation, simple usage example, API overview, TypeScript types, contributing guidelines, license, badges.

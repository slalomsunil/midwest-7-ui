# Architecture Custom Modes

Custom modes in this category focus on reviewing architectural decisions, analyzing system design, and assessing dependencies and coupling.
...
### Architecture Reviewer
1. Switch to architecture-reviewer mode via `Cmd+.` (Mac) / `Ctrl+.` (Windows/Linux)
...
- **Rules**: `../../../rules/cursor/base/` - Base design standards
- **Commands**: `../../../commands/cursor/architecture/` - Commands for specific workflows

# Code Quality Chat Modes

Chat modes in this category focus on maintaining and improving code quality through review, refactoring guidance, and technical debt analysis.
...
- When you just want to understand existing code (use Ask mode)
...
### Code Reviewer
1. Switch to code-reviewer mode via mode selector
...
- **Tools**: Add `search` tool if modes should research best practices online

## Related Resources

- **Rules**: `../../../rules/copilot/base/` - Base code quality standards
- **Commands**: `../../../commands/copilot/code-quality/` - Prompt files for specific workflows
...
└── .github/
    └── chatmodes/
        ...
        ├── refactoring-advisor.chatmode.md
        └── tech-debt-analyzer.chatmode.md
```

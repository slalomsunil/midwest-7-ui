...
Chat modes in this category focus on creating, analyzing, and improving tests to ensure code quality and reliability.
...
### Test Generator
1. Switch to test-generator mode via mode selector
...
- **Tools**: Add `search` tool if modes should research testing best practices online

## Related Resources

- **Rules**: `../../../rules/copilot/base/` - Testing quality standards
- **Commands**: `../../../commands/copilot/testing/` - Prompt files for specific workflows
...
└── .github/
    └── chatmodes/
        ...
        ├── coverage-analyzer.chatmode.md
        └── test-improver.chatmode.md
```
